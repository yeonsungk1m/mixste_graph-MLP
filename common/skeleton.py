...
class Skeleton:
    ...
    def _compute_metadata(self):
        ...
        # self.bones_names = tuple(
        #     f"{self.joints_names[j]}->{self.joints_names[i]}"
        #     for i, j in self.bones
        # )

        # Creates left and right bones indices list
        bone_parent = dict(self.bones)
        ...
        self.bones_left = tuple(bone_index[b] for b in skeleton_left)
        self.bones_right = tuple(bone_index[b] for b in skeleton_right)
