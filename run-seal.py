...
if args.resume or args.evaluate:
    ...
    model_loss.load_state_dict(checkpoint['model_loss'], strict=False)
...
if not args.evaluate:
    ...
    optimizer_loss = optim.AdamW(model_loss.parameters(), lr=lr_loss, weight_decay=0)
    ...
    if args.em_loss_type == 'nce':
        loss_fn_loss = NCELoss()
    elif args.em_loss_type == 'margin':
        loss_fn_loss = MarginBasedLoss(loss_type=args.margin_type)
    ...
    for epoch in tqdm(range(epoch, args.epochs), desc="epoch"):
        ...
        for cameras_train, batch_3d, batch_2d in tqdm(train_generator.next_epoch()):
            ...
            # print(inputs_2d.shape, inputs_3d.shape, predicted_3d_pos.shape) # delete
